...
server <- function(input, output, session) {
  ...
  session$onSessionEnded(function() {
   ...
   Work2BDone = reactive({
    ...
    req(input$file$datapath, input$Av_Interval, input$Base_Av_Interval, input$Stim_Av_Interval, input$Av_Interval_2, input$HtCorrect, input$condition)
    
    MainFunction_JM(input$file$datapath, input$Av_Interval, input$Base_Av_Interval, input$Stim_Av_Interval, input$Av_Interval_2, input$HtCorrect, input$condition)
